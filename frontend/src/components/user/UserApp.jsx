...
export default function UserApp() {
  ...
  return (
    <div
      className="min-h-screen flex items-stretch justify-center sm:py-10 sm:px-4"
      style={{ background: 'linear-gradient(160deg, #EAF6EE 0%, #F3F0FB 100%)' }}
    >
      <div className="w-full sm:max-w-md bg-white sm:rounded-3xl sm:shadow-lift flex flex-col h-screen sm:h-[720px] overflow-hidden">
        <ChatHeader
