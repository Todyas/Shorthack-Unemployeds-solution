...
const ENDPOINTS = [
  ...
  { method: 'GET', path: '/api/kb', description: 'База знаний — статьи, по которым ИИ ищет шаблоны ответов' },
  ...
  return (
    <section>
      <header className="h-16 border-b border-ink-200 bg-white flex items-center justify-between px-6">
        ...
        <button
          onClick={checkHealth}
          className="text-sm font-medium px-3 py-1.5 rounded-full border border-ink-200 hover:bg-ink-50"
        >
          Проверить снова
        </button>
      </header>
        ...
        <div className="surface p-5">
          <div className="flex items-center justify-between mb-3">
            ...
            <button
              ...
              className="text-sm font-medium px-3 py-1.5 rounded-full border border-ink-200 hover:bg-ink-50 disabled:opacity-60"
            >
        ...
        <div className="surface p-5">
          ...
          <div className="flex flex-wrap gap-2">
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="text-sm font-medium px-3 py-1.5 rounded-full bg-sber-500 text-white hover:bg-sber-600 shadow-soft"
            >
              Swagger UI
            </a>
            <a
